...
namespace UnityUtilitiesTests
{
    ...
    public class ColorExtensionsTests
    {
        ...
        [TestCase(1/2f, 0f, 1/3f, 0f)]
        [TestCase(1/1f, 1/5f, 1/5f, 0f)]
        ...
        [TestCase(null, null, null, 1f)]
        [TestCase(1/2f, null, null, null)]
        [TestCase(null, 1/3f, null, 0.5f)]
        [TestCase(null, null, 1f, null)]
        [TestCase(1/2f, 1/3f, null, null)]
        [TestCase(null, 0f, 1/2f, null)]
        [TestCase(1/2f, null, 3f, 1/3f)]
        [TestCase(1/2f, 1/3f, 1/4f, 1/5f)]
        ...
        [Test]
        [TestCase(null, null, null, null)]
        [TestCase(null, null, null, 255)]
        [TestCase(128, null, null, null)]
        [TestCase(null, 64, null, 128)]
        [TestCase(null, null, 255, null)]
        [TestCase(127, 33, null, null)]
        [TestCase(null, 13, 56, null)]
        [TestCase(64, null, 33, 64)]
        [TestCase(128, 44, 55, 32)]
