...
namespace UnityUtilitiesTests
{
	...
	{
		[Test, TestCase(0f, 0f, 0f), TestCase(0f, 0f, 1f), TestCase(0f, 0f, -2f), TestCase(0f, 2f, 0f),
		 TestCase(0f, -1f, 0f), TestCase(5f, 0f, 0f), TestCase(-3f, 0f, 0f), TestCase(1f, 2f, 3f),
		 TestCase(-1f, 3f, 0f)]
		...
		[Test, TestCase(0f, 0f), TestCase(0f, 2f), TestCase(0f, -1f), TestCase(5f, 0f), TestCase(-3f, 0f),
		 TestCase(1f, 2f), TestCase(-1f, 3f)]
		...
		[Test, TestCase(null, null, null), TestCase(2f, null, null), TestCase(null, 3f, null),
		 TestCase(null, null, -1f), TestCase(2f, 3f, null), TestCase(null, 0f, 2f), TestCase(2f, null, 3f),
		 TestCase(2f, 3f, 4f)]
		...
		[Test, TestCase(null, null), TestCase(2f, null), TestCase(null, 3f), TestCase(2f, 3f)]
